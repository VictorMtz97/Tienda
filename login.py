...
class Login(tk.Frame):
    def __init__(self, parent, controlador):
        super().__init__(parent,bg="#050520")
        ...
        #Titulo
        self.label_texto1= tk.Label(self, text="INICIO DE SESIÓN", bg=bg_color, fg="#ffffff").pack(pady=(0, 40))

        #Usuario
        tk.Label(self, text="Usuario", font=title_font).pack()
        self.entry_usuario = tk.Entry(self, font=("Arial", 12), bd=0, highlightthickness=1)
        self.entry_usuario.pack(ipady=8, pady=(5, 20))

        #Contraseña
        self.label_texto3= tk.Label(self, text="Contraseña", font=title_font).pack()
        ...
        check = tk.Checkbutton(self, text="Mostrar contraseña",variable=self.check_var,command=self.mostrar_password, bg=bg_color, fg="white", 
                           selectcolor="#050520", activebackground=bg_color, 
                           activeforeground="white")
        check.pack(anchor="w", pady=(0, 30))
